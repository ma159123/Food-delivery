...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButton=TextButton.styleFrom(
      ...
      maximumSize: Size(width!=null?width!:Dimensions.screenWidth, height!=null?height!:Dimensions.height45),
    ...
    return Center(
      child: SizedBox(
        width: width??Dimensions.screenWidth/1.2,
        ...
        child: TextButton(
          ...
          child: Row(
            ...
            children: [
              icon!=null?Padding(padding: EdgeInsets.only(right: Dimensions.width15/3),
