...
class _PaymentPageState extends State<PaymentPage> {
  ...
  void _redirect(String url) {
    ...
    if (_canRedirect) {
      ...
      if (_isSuccess) {
        Get.offNamed(AppRoute.getOrderSuccessPage(widget.orderModel.id.toString(),'success'));
      } else if (_isFailed || _isCancel) {
        Get.offNamed(AppRoute.getOrderSuccessPage(widget.orderModel.id.toString(),'fail'));
      } else {
